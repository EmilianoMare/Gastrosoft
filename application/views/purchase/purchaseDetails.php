                ...
                <div class="row">
                    ...
                    <div class="col-md-3 pull-right">
                        ...
                        <div class="form-group">
                            ...
                            <p class="">
                                <?php echo escape_output(getPaymentName($purchase_details->payment_id, isset($purchase_details->online_payment_details) ? $purchase_details->online_payment_details : '')) ; ?>
                            </p>
